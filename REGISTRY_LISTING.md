...
- [ ] Confirm `package.json`: `name` `@edgedepth/research-mcp`, `version` `0.6.0`, `mcpName` `com.edgedepth/research`, `bin`, and `files` (`dist`, `README.md`, `server.json`).
...
- [ ] Verify: `https://www.npmjs.com/package/@edgedepth/research-mcp` shows 0.6.0, and `npx -y @edgedepth/research-mcp` starts (set `EDGEDEPTH_API_KEY` first).
